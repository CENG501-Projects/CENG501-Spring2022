...
def main(config):
    ...
    if config["model"] == "sfsr":
        model = SFSR.load_model(config["model_path"])
    else:
    ...
    with torch.no_grad():
        ...
        for i, (data) in enumerate(data_loader):
            ...
            _, estimate_source = model(padded_mixture)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-C",
                        "--configuration",
                        default="/home/arda/Desktop/plotting/config/test/evaluate.json5",
                        type=str,
