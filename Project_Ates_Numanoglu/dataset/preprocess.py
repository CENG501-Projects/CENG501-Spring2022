"""
    The code is taken from public GitHup repository of Zhongyang-debug. GitHub repository of Zhongyang-debug including reproduction of SepFormer model, can be found at:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--in-dir',
                        type=str,
                        default="/content/Attention-Is-All-You-Need-In-Speech-Separation-main/min",
                        help='Directory path of wsj0 including tr, cv and tt')

    parser.add_argument('--out-dir',
                        type=str,
                        default="/content/Attention-Is-All-You-Need-In-Speech-Separation-main/json",
