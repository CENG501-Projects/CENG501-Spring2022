...
class InceptionScore():
    ...
    def updateWithMiniBatch(self, ref):
        ...
        #predFakeG = self.classifier.netG(ref)
        torch.reshape(ref, (-1,256))
        self.classifier.netD.train(False)
        self.classifier.netG.train(False)
        y = self.classifier.netD(ref, False)
